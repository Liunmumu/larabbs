...
return array(
    ...
    /*
     *  Domain for routing. 后台专属域名，没有的话可以留空
     *
     *  @type string
     */
    'domain' => '',
    ...
    /*
     * Page title. 应用名称，在页面标题和左上角站点名称处显示
     *
     * @type string
     */
    'title' => env('APP_NAME', 'HappyBBS'),

    /*
     * The path to your model config directory. 模型配置信息文件存放目录
     *
     * @type string
     */
    ...
    /*
     * The path to your settings config directory. 配置信息文件存放目录
     *
     * @type string
     */
